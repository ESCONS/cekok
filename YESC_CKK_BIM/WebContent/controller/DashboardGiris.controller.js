sap.ui.define(
	...
	function (BaseController, MessageToast, Filter, FilterOperator, formatter, jQuery, Fragment, MessageBox) {
		...
		return BaseController.extend("urungiris.controller.DashboardGiris", {
			formatter: formatter,

			onInit: function (oEvent) {

				var oRouter = this.getRouter();
				oRouter.getRoute("dashboardGiris").attachMatched(
			...
			_onRouteMatched: function (oEvent) {
				...
				if (this.type === "B") {
				...
				} else if (this.type === "C" || this.type === "A") {
					...
					var mcbBimKullanici = this.getView().byId("mcbBimKullanici");
					mcbBimKullanici.unbindItems();
			...
			onPressIleri: function (oEvent) {
				...
				if (this.type === "B") {
					...
					if (mcbBimKullanici.length === 0) {
						this.getMessage("kullaniciSecErr");
						return;
					}
